              ...
              return (
                <div key={category}>
                  <button
                    ...
                    className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 transition-colors text-sm font-semibold uppercase tracking-wider"
                  >
                    {category}
                    <ChevronDown
